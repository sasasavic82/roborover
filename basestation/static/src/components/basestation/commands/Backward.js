...
const Backward = ( {commandId, onRemove = () => {}, onCommandChanged = () => {}}) => {
    ...
    return (
            <Row className="border-bottom pb-2">
                <Col xs="1">
                    <h1><i className="fas fa-arrow-down text-success" /></h1>
                </Col>
                <Col xs="2">
                    <h2 className="font-medium float-left mt-0">Backward</h2>
                </Col>
                <Col xs="6">
